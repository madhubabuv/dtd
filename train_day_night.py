...
def train(epoch):
    ...
    for iter, data in progress_bar:
        ...
        #    left_image, right_image, return_distance=True, masks=True, norm=True,return_dict = True
        # )
        ...
        #     std = torch.std(torch.nn.functional.normalize(all_h,dim = 1), dim=1, keepdim=True)
        ...
        # progress_bar.set_description(
        #     "epoch: {}/{} training loss: {:.4f} photo_loss: {:.4f}, extra_loss: {:.4f}".format(
        #         epoch,
        #         args.num_epochs,
        #         total_loss.item(),
        #         loss.item(),
...
if __name__ == "__main__":
    ...
    checkpoint_dir = (
        "/mnt/nas/madhu/data/checkpoints/chapter_4_cvpr/d_n_v2"
    )
    # checkpoint_path = (
    #     "/mnt/nas/madhu/data/checkpoints/chapter_4_cvpr/d_n_v1/depth_net_10.pth"
    # )
